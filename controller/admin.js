...
//                 console.log(tKeyMd5)
//                 redis.get(req.headers.fapp + ':tag:' + tKeyMd5).then
//                     ((data1) => {
//                         if (!data1) {
//                             data1 = []
//                         }
...
//             redis.zadd(req.headers.fapp + ':a_time',
//                 key, Date.now())
//             redis.zadd(req.headers.fapp + ':a_view',
//                 key, 0)
//             redis.zadd(req.headers.fapp + ':a_like',
//                 key, 0)
//             res.json(util.getReturnData(0, '新建成功'))
//         })
//     }
// }
